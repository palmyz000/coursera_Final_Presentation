...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        # For ALL sites, show the total successful launches per site
        filtered_df = spacex_df[spacex_df['class'] == 1].groupby('Launch Site').size().reset_index(name='Success Count')
        fig = px.pie(filtered_df, values='Success Count', names='Launch Site', 
